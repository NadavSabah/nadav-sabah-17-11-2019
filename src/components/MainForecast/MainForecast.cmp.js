...
import FiveDayForecast from '../FiveDayForecast/FiveDayForecast.cmp'
...
const MainForecast = ({ getCityData, getFiveDayCityWeather, cityFiveDayWeather,
    ...
    const FavoriteStar = () => {
        ...
        const handleFavorite = async () => {
            ...
            // const isExist = await addToFavorite(favoriteCity, favoritesList)
            if (!isFavorite) {
                Swal.fire(
                        ...
                        <div className="flex justify-content flex-wrap">
                            {cityFiveDayWeather.DailyForecasts && (
                                cityFiveDayWeather.DailyForecasts.map((dayForecast, idx) =>
                                    <FiveDayForecast key={idx} dayForecast={dayForecast} isFahrenheit={isFahrenheit}></FiveDayForecast>
